        ...
        do {
            ...
            if (choose == 1) {
                ...
                try {
                    ...
                    var last = danhSachHoaDon.size() - 1;
                    for (int i = 0; i < danhSachHoaDon.size(); i++) {
                        if (danhSachHoaDon.get(i).tongTien() > hd.tongTien()) {
                        } else {
                            HoaDon temp = danhSachHoaDon.get(i);
                            danhSachHoaDon.set(i, hd);
                            danhSachHoaDon.set(last, temp);
                            break;
                        }
                    }
                } catch (ParseException e) {
...
class HoaDon {
    ...
    static HoaDon input(Scanner s, DanhSachKhachHang dsKH, DanhSachSanPham dsSP) throws ParseException {
        ...
        if (!found) {
            ...
            KhachHang k = KhachHang.input(s, true);
            dsKH.add(k);
            ret.kh = k;
        }
